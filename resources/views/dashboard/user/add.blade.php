...
<div class="container">
   ...
   <div class="row">
       <div class="col-md-6">
        ...
        <input type="text" class="form-control  @error('name') is-invalid @enderror is-valid" name="name" id="exampleFormControlInput1" placeholder="Nama pengguna">
   ...
   <div class="alert alert-danger">{{ $message }}</div>
       ...
       <div class="col-md-6">
        ...
        <input type="email" class="form-control  @error('email') is-invalid @enderror is-valid" name="email" id="exampleFormControlInput1" placeholder="Email pengguna">
        <div class="valid-feedback">
          @error('email')
   <div class="alert alert-danger">{{ $message }}</div>
       @enderror
